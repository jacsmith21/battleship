...
public class Game extends JPanel implements ActionListener{
	...
	/** The last grid grid button clicked */
	...
	*/	
	public GridButton[][] setGrid(JPanel panel){
	...
	*/
	public void setUnclickable(GridButton[][] buttons){
	...
	/** Sets the buttons in the array to clickable
		@param buttons The button array
	*/
	public void setClickable(GridButton[][] buttons){
		for(int i = 0; i < buttons.length; i++){
			for(int j = 0; j < buttons[0].length; j++){
	...
	*/
	...
	public int[] getIntCoordinates(String coordinate){
		char c = coordinate.charAt(0);
        int col = c - 65;
		int row = Integer.parseInt(coordinate.substring(1)) - 1; //Starts at 0
		int[] temp = {row, col};
		return temp;
	}
